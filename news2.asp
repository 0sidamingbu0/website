  ...
  <tr>
    <td width="670" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="160" align="center" valign="top"><img onclick="location.href='images.asp?id=<%=rs("id")%>&im=1&scr=news2'" name="" src="upload/<%=rs("mce")%>/1_160120.jpg" height="120" alt="" /></td>
        <td width="5" valign="top">&nbsp;</td>
        <td width="160" align="center" valign="top"><img onclick="location.href='images.asp?id=<%=rs("id")%>&im=2&scr=news2'" name="" src="upload/<%=rs("mce")%>/2_160120.jpg" height="120" alt="" /></td>
        <td width="5" valign="top">&nbsp;</td>
        <td width="160" align="center" valign="top"><img onclick="location.href='images.asp?id=<%=rs("id")%>&im=3&scr=news2&curpage=<%=curpage%>'" name="" src="upload/<%=rs("mce")%>/3_160120.jpg" height="120" alt="" /></td>
