...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="810" height="50" align="left"background="images/sb_bg2.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="daohang_lj"><a href="index.asp">首页</a> &gt; <a href="news.asp">新闻</a> &gt; <%=rs("mc")%> &gt; <%if session("islogin")="yes" then%>
...
%>
  ...
  <tr>
    <td width="670" valign="top"><form id="form3" name="form3" method="post" action="idolnews2.asp?id=<%=request("id")%>">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="20" colspan="7"><div align="center"><span class="daohang_lj" style="font-size:14px">
       
        id=<%=rs("id")%>&nbsp;&nbsp;mc=
          <input name="mc" type="text" id="mc" value="<%=rs("mc")%>" size="10" maxlength="300" />
          &nbsp;&nbsp;mce=
	  ...
	  session(rs("id"))="yes"
	  %>
        <td height="20" colspan="7" valign="top"><div align="center"><span class="daohang_lj" style="font-size:11px">发布日期：<input name="date" type="text" id="date" value="<%=rs("date2")%>" size="8" maxlength="30" />&nbsp;&nbsp;点击：<span class="daohang_lj" style="font-size:11px"><input name="djs" type="text" id="djs" value="<%=rs("djs")%>" size="8" maxlength="30" />&nbsp;&nbsp;来源：<span class="daohang_lj" style="font-size:11px"><span class="daohang_lj" style="font-size:11px">
          <input name="from2" type="text" id="from2" value="<%=rs("from2")%>" size="8" maxlength="30" />&nbsp;&nbsp;类别：<input name="leibie" type="text" id="leibie" value="<%=rs("leibie")%>" size="8" maxlength="30" />
        </span></span></span></span></div></td>
      </tr>
      <tr>
        <td width="95" height="120" valign="top">&nbsp;</td>
        <td width="160" align="center" valign="top"><img onclick="location.href='images.asp?id=<%=rs("id")%>&im=1&scr=idolnews2'" name="" src="upload/<%=rs("mce")%>/1_160120.jpg" height="120" alt="" /></td>
        <td width="5" valign="top">&nbsp;</td>
        <td width="160" align="center" valign="top"><img onclick="location.href='images.asp?id=<%=rs("id")%>&im=2&scr=idolnews2'" name="" src="upload/<%=rs("mce")%>/2_160120.jpg" height="120" alt="" /></td>
        <td width="5" valign="top">&nbsp;</td>
        <td width="160" align="center" valign="top"><img onclick="location.href='images.asp?id=<%=rs("id")%>&im=3&scr=idolnews2'" name="" src="upload/<%=rs("mce")%>/3_160120.jpg" height="120" alt="" /></td>
      ...
      <tr>
        ...
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            </span><input type="submit" name="button" id="button" value="提交" /></td>
          </tr>
        </table></td>
      </tr>
    </table>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
         <form id="form5" name="form5" method="post" action="news.asp">
