	...
	<body>
						...
						<div class="row">
							<div class="4u">
								<section>
									...
									<footer>
										<a href="#third" class="button scrol
									</footer>
								</section>
							</div>
							<div class="8u">
		...
		<!-- Fourth -->
			<section id="fourth" class="main">
				<header>
                    <form method="post" action="marrydeltz.asp">
					<div class="container">
						<h2>留言板</h2>
                        <p>
                            想对我们说的话<br />
                        ...
                        <p>
                            ...
                            <%=rs2("name")%>&nbsp;<%=rs2("date")%>&nbsp;<input type="submit" name="dell" id="dell" value="<%=rs2("id")%>" />
                            </p>
                        <p>
                            <%=rs2("message")%>
                        </p>
			...
			<section id="footer">
				...
				<div class="copyright">
					<ul class="menu">
						...
						<li>More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">XX & WY</a></li-->
					</ul>
				</div>
			</section>
