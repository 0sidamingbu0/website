...
sql="delete from config where id="&dell      
conn.Execute sql
end if%>
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="810" height="50" align="left"background="images/sb_bg2.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="daohang_lj"><a href="index.asp">首页</a> &gt; 新闻中心 &gt; <%if session("islogin")="yes" then%>
...
%>
  ...
  <tr>
	...
	<%if a=1 then 
	exec="select * from config where leibie='电视' or leibie='报纸' or leibie='杂志' order by date2 DESC"%>
	<%else 
	exec="select * from config where leibie='电视' or leibie='报纸' or leibie='杂志' order by djs DESC" %>
	<%end if%>
...
%>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="534" height="130" rowspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="518" height="120" class="daohang_lj"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=neirong%>
             ...
             <%if session("islogin")="yes" then%>
            <a href="idolvideo2.asp?id=<%=rs("id")%>">【详细介绍】</a>
            <%else%>
      ...
      <tr>
        <td width="160" height="120" align="center"><img onclick="location.href='images.asp?id=<%=rs("id")%>&scr=news&curpage=<%=curpage%>'"src="upload/<%=rs("mce")%>/1_160120.jpg" height="120"/></td>
      </tr>
      <tr>
