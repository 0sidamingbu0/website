...
<form id="form2" name="form2" method="post" action="tiaozhuanyanzheng.asp">
<input type="hidden" name="id" value="<%=id9%>"/>
...
<%  randomize
	...
	m2=int((89+1)*rnd+10)
%>
<input type="hidden" name="yanzheng" id="yanzheng" value="<%=m1+m2%>" />
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
