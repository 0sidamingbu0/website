...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="810" height="50" align="left"background="images/sb_bg2.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="daohang_lj"><a href="index.asp">首页</a> &gt; 密码 &gt; <%if session("islogin")="yes" then%>
...
<table width="960"  align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="960" height="12" align="center"><form id="form2" name="form2" method="post" action="idolxgmm.asp">
      <p><%  exec8="select * from idol where id=1"
set rs8=server.createobject("adodb.recordset")   
rs8.open exec8,conn,1,3
nam=Request.Form("nam")
pw=Request.Form("pw")
if session("islogin")="" then %>
<span class="daohang_lj">非法操作！</span>
<%else
...
rs8.update
				%>
                <span class="daohang_lj">密码修改成功！</span>
                <%end if%>
                </p>
      <p>
        <label class="daohang_lj">用户名：
          <input name="nam" type="text" id="nam" value="<%=rs8("idol")%>" size="15" />
        </label>
      </p>
      <p>
        <label class="daohang_lj">密 &nbsp;&nbsp;码： 
<input name="pw" type="password" id="pw" size="16" />
        </label>
      </p>
      ...
      <p><a class="daohang_lj" href="idol2.asp">返回</a></p><%end if%>
    </form></td>
  </tr>
</table>
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
