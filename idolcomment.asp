  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<% exec11="select * from config where id="&id
set rs11=server.createobject("adodb.recordset")   
rs11.open exec11,conn,1,3   %>
...
<%	
 ...
 exec="select * from comment where suoshu="&id&" order by date2 DESC"
...
%>
    ...
    <form id="form3" name="form3" method="post" action="idolcomment.asp?id=<%=request("id")%>&id3=<%=rs("id")%>">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
	...
	%>
            <td width="510" height="25" class="daohang_lj" style="font-size:14px">&nbsp;&nbsp;id=<%=rs("id")%>&nbsp;&nbsp;&nbsp;&nbsp;mc=<span class="daohang_lj" style="font-size:12px">&nbsp;&nbsp;&nbsp;日期：<span class="daohang_lj" style="font-size:14px"><span class="daohang_lj" style="font-size:12px">
              <span class="daohang_lj" style="font-size:14px">
              <input name="mc" type="text" id="mc" value="<%=rs("mc")%>" size="30" maxlength="50" />
              </span>
...
%>
     ...
     <form id="form5" name="form5" method="post" action="idolcomment.asp">
