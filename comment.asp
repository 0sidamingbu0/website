...
%>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><span  class="daohang_lj" style="font-size:16px"><div align="center"></div></span></td>
      </tr>
    </table>
    <p>&nbsp;      </p>
...
%>
	...
	%>
            <td width="510" height="25" class="daohang_lj" style="font-size:14px">&nbsp;&nbsp;<%=mc2%><span class="daohang_lj" style="font-size:12px">&nbsp;&nbsp;&nbsp;<%=rs("date2")%></span></td>
            <td width="160" height="25" align="right" class="daohang_lj">&nbsp;<%=rs("ip")%> &nbsp;&nbsp;&nbsp;&nbsp;</td>
          </tr>
      ...
      <tr>
        <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="19"><p><span class="daohang_lj" style="font-size:12px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=rs("neirong")%></span></p>
              <%if Len(rs("huifu"))>0 then%>
              <p class="daohang_lj" style="color:#F00">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;回复：<%=rs("huifu")%></p>
              <%else%>
              <%end if%>
              </td>
            </tr>
