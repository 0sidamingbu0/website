...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="810" height="50" align="left"background="images/sb_bg2.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="daohang_lj"><a href="index.asp">首页</a> &gt; 合作项目 &gt; 
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="43" class="daohang_lj"><p>&nbsp;</p></td>
    <td width="411" class="daohang_lj" style="font-size:16px"><p>&nbsp;</p>
      <p>合作项目：<br />
        中央电视台10套走进科学栏目(道具制作)<br />
        中科院某部门(技术交流)<br />
        山西某彩灯公司合作(制作模型)<br />
        某矿场基地(探测设备)<br />
        新疆某个人(棉花采摘机)<br />
...
主页: www.yulurobot.com</p></td>
    <td width="506" class="daohang_lj"><img src="images/about/3.jpg" width="350" height="262" /></td>
  </tr>
</table>
</body>
</html>
