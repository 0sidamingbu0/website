...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="810" height="50" align="left"background="images/sb_bg2.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="daohang_lj"><a href="index.asp">首页</a> &gt; 登录</span></td>
  </tr>
</table>
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
<table width="960"  align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="960" height="12" align="center"><form id="form2" name="form2" method="post" action="idol2.asp">
      <p><%  randomize
					m1=int((89+1)*rnd+10)
					randomize
					m2=int((89+1)*rnd+10)
				%><input type="hidden" name="yanzheng" id="yanzheng" value="<%=m1+m2%>" /></p>
      <p>
        <label class="daohang_lj">用户名：
          <input name="nam" type="text" id="nam" size="15" />
        </label>
      </p>
      <p>
...
<input name="pw" type="password" id="pw" size="16" />
      ...
      <p>
        <label class="daohang_lj">验证码：&nbsp;<%=m1%>+<%=m2%>=&nbsp;&nbsp;
          <input name="yanzheng2" type="text" id="yanzheng2" size="5" />
        </label>
      </p>
      <p>
        <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
