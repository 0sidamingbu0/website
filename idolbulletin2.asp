...
tps=CINT(Request.Form("tps"))
mcc=Request.Form("mc")
djss=CINT(Request.Form("djs"))
datee=Request.Form("date")
mcee=Request.Form("mce")
flvurl2=Request.Form("flvurl2")
neirongg=Request.Form("neirong")
neirongg=replace(neirongg,chr(13),"<br/>")
neirongg=replace(neirongg," ","&nbsp;")
neirongg=replace(neirongg,"<链接开始>","<a style='color:#F00' href='video2.asp?id=")
neirongg=replace(neirongg,"<链接结束>","'>点击查看视频</a>")
...
%>
  ...
  <tr>
    ...
    <form id="form3" name="form3" method="post" action="idolbulletin2.asp?id=<%=request("id")%>">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="20" colspan="7"><div align="center"><span class="daohang_lj" style="font-size:14px">id=<%=rs("id")%>&nbsp;&nbsp;mc=
          <input name="mc" type="text" id="mc" value="<%=rs("mc")%>" size="30" maxlength="300" />
          &nbsp;&nbsp;mce=
          <input name="mce" type="text" id="mce" value="<%=rs("mce")%>" size="7" maxlength="30" />&nbsp;&nbsp;tps=<input name="tps" type="text" id="tps" value="<%=rs("tps")%>" size="7" maxlength="30" /></span></div></td>
      </tr>
      <tr>
	  ...
	  session(rs("id"))="yes"
	  %>
        <td height="20" colspan="7" valign="top"><div align="center"><span class="daohang_lj" style="font-size:11px">发布日期：<input name="date" type="text" id="date" value="<%=rs("date2")%>" size="15" maxlength="30" />&nbsp;&nbsp;点击：<span class="daohang_lj" style="font-size:11px"><input name="djs" type="text" id="djs" value="<%=rs("djs")%>" size="8" maxlength="30" />&nbsp;&nbsp;来源：<input name="from2" type="text" id="from2" value="<%=rs("from2")%>" size="8" maxlength="30" />&nbsp;&nbsp;类别：<input name="leibie" type="text" id="leibie" value="<%=rs("leibie")%>" size="8" maxlength="30" /></span></span></div></td>
      </tr>
      <tr>
        <td width="95" height="120" valign="top">&nbsp;</td>
        <td width="160" align="center" valign="top"><img onclick="location.href='images.asp?id=<%=rs("id")%>&im=1&scr=idolbulletin2'" name="" src="upload/<%=rs("mce")%>/1_160120.jpg" height="120" alt="" /></td>
        <td width="5" valign="top">&nbsp;</td>
        <td width="160" align="center" valign="top"><img onclick="location.href='images.asp?id=<%=rs("id")%>&im=2&scr=idolbulletin2'" name="" src="upload/<%=rs("mce")%>/2_160120.jpg" height="120" alt="" /></td>
        <td width="5" valign="top">&nbsp;</td>
        <td width="160" align="center" valign="top"><img onclick="location.href='images.asp?id=<%=rs("id")%>&im=3&scr=idolbulletin2'" name="" src="upload/<%=rs("mce")%>/3_160120.jpg" height="120" alt="" /></td>
        <td width="95" valign="top">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="7" valign="top">
        <p style="color:#F00" class="daohang_lj">注意：各项都不能为空！mc=标题&nbsp;mce=存放文章相关资源的文件夹名称，放在/upload/下面,发布日期格式为：2010/8/8 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点击数必须为数字不能为空！若有空项修改不会成功</p>
        <p style="color:#F00" class="daohang_lj">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;公告如果有站内视频资料请按照如下格式： &quot; &lt;链接开始&gt;此文章的id<span class="daohang_lj" style="color:#F00">&lt;链接结束&gt;</span>&quot;书写</p>
        <p style="color:#F00" class="daohang_lj">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;或者有优酷视频引用请填写&nbsp;&nbsp;flash url=
          <input name="flvurl2" type="text" id="flvurl2" value="<%=rs("flvurl2")%>" size="30" maxlength="300" />
          &nbsp;注意：若无优酷视频请勿动</p>
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><span class="daohang_lj" style="font-size:13px">
              <textarea name="neirong" cols="80" rows="20" id="neirong"><%=rs("neirong")%></textarea>
            </span><input type="submit" name="button" id="button" value="提交" />
            </td>
          </tr>
        </table></td>
      </tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
        <form id="form5" name="form5" method="post" action="bulletin.asp">
          <td align="right"><input type="submit" name="button2" id="button2" value="删除" /><input type="hidden" name="dell" id="dell" value="<%=rs("id")%>" /></td>
          </form>
        </tr>
    </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <p>
            ...
            <%if session("islogin")="yes" then%>
             <a class="daohang_lj" href="idolcomment.asp?id=<%=rs("id")%>"  style="font-size:11px">&nbsp;&nbsp;显示全部</a>
            <%else%>
             <a class="daohang_lj" href="comment.asp?id=<%=rs("id")%>"  style="font-size:11px">&nbsp;&nbsp;显示全部</a>
   			<%end if%> 
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
