...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="810" height="50" align="left"background="images/sb_bg2.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="daohang_lj"><a href="index.asp">首页</a> &gt; 视频 &gt; <%if session("islogin")="yes" then%>
...
%>
  ...
  <tr>
	...
	<%if a=1 then 
	exec="select * from config where leibie='电视' or leibie='作品' order by date2 DESC"%>
	<%else 
	exec="select * from config where leibie='电视' or leibie='作品' order by djs DESC" %>
	<%end if%>
...
%>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="160" height="120" align="center"><img onclick="location.href='images.asp?id=<%=rs("id")%>&curpage=<%=curpage%>&scr=video'" src="upload/<%=rs("mce")%>/1_160120.jpg" height="120" /></td>
      </tr>
      <tr>
