...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="810" height="50" align="left"background="images/sb_bg2.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="daohang_lj"><a href="index.asp">首页</a> &gt; 访问统计 &gt; <%if session("islogin")="yes" then%>
...
<table width="960"  align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="960" height="12" align="center"><form id="form2" name="form2" method="post" action="idolfwltj.asp">
...
rs8.update
				%>
                <span class="daohang_lj">修改成功！</span>
                <%end if%>
                </p>
      <p>
        <label class="daohang_lj">访问量：
          <input name="nam" type="text" id="nam" value="<%=rs8("fangwen")%>" size="15" />
        </label>
      </p>
